  ...
  return (
    ...
    <div className="w-64 h-screen py-8 px-4 flex flex-col bg-black/40 backdrop-blur-md border-r border-white/10">
      <div className="flex items-center gap-3 px-4 mb-8">
        <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-gray to-black flex items-center justify-center">
          <Image
      ...
      <div className="mt-auto">
        <div className="mx-3 p-4 rounded-xl bg-white/20 backdrop-blur-sm border border-white/20">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-300">
            Your protein intake is below target. Consider adding more protein
            sources.
          </p>
        </div>
      </div>
